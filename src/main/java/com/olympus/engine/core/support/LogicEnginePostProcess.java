...
import com.olympus.engine.extension.init.LogicEngineInitProcess;
import com.olympus.engine.utils.PackageScanUtils;
...
public class LogicEnginePostProcess implements ImportSelector {
    ...
    public String[] selectImports(AnnotationMetadata annotationMetadata) {
        ...
        Class<com.olympus.engine.extension.template.Template>[] sceneProcessTemplateClasses = UncheckCastUtil.castUncheckedObject(values.get(0));
